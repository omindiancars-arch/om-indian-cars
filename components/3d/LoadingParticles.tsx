...
export default function LoadingParticles() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-black overflow-hidden p-4">
      {/* Background Ambience */}
      <div className="absolute inset-0 bg-[#A10B1C]/10" />
      ...
      <div className="relative w-full max-w-[500px] flex flex-col items-center justify-center">
        {/* Animated Glow */}
        <motion.div
          className="absolute w-[180%] h-[180%] bg-[#A10B1C]/15 blur-[80px] md:blur-[120px] rounded-full"
          animate={{ 
            scale: [1, 1.1, 1],
            opacity: [0.3, 0.6, 0.3]
          }}
          ...
          >
            <defs>
              <linearGradient id="premiumGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#A10B1C" />
                <stop offset="50%" stopColor="#FFFFFF" />
                <stop offset="100%" stopColor="#A10B1C" />
              </linearGradient>
              <filter id="glow">
        ...
        <div className="mt-8 md:mt-12 flex flex-col items-center gap-6">
          ...
          >
            {[...Array(3)].map((_, i) => (
              <motion.div
                key={i}
                className="w-2 h-2 bg-[#A10B1C] rounded-full"
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <motion.div 
              className="h-[1px] w-12 bg-[#A10B1C]/50"
              initial={{ scaleX: 0 }}
              animate={{ scaleX: 1 }}
