        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-24 mb-24">
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-5">
              {["Buy a Car", "Sell Your Car", "Finance", "Insurance", "About Us"].map((link) => (
                <Link key={link} href={link === "Buy a Car" ? "/cars" : link === "Sell Your Car" ? "/sell" : link === "Finance" ? "/finance" : link === "Insurance" ? "/insurance" : "/about"} className="text-[11px] font-bold uppercase tracking-widest text-white/40 hover:text-white transition-colors">
                  {link}
                </Link>
              ))}
            </div>
