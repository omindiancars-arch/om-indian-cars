...
export default function Footer() {
  return (
    <footer className="bg-black text-white pt-32 pb-16 relative z-20 overflow-hidden">
      {/* Background Accents */}
      <div className="absolute top-0 right-0 w-1/3 h-full bg-[#B31B1B]/5 -skew-x-12 translate-x-1/2" />
      <div className="absolute bottom-0 left-0 w-1/4 h-full bg-[#B31B1B]/5 skew-x-12 -translate-x-1/2" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-24 mb-24">
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#B31B1B] hover:border-[#B31B1B] transition-all cursor-pointer">
                <Instagram size={18} />
              </div>
              <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#B31B1B] hover:border-[#B31B1B] transition-all cursor-pointer">
                <Facebook size={18} />
          ...
          {/* Services */}
          <div className="flex flex-col gap-10">
            <h4 className="text-xs font-black uppercase tracking-[0.4em] text-[#B31B1B]">Our Services</h4>
            <div className="flex flex-col gap-5">
          ...
          {/* Contact Details */}
          <div className="flex flex-col gap-10">
            <h4 className="text-xs font-black uppercase tracking-[0.4em] text-[#B31B1B]">Get in Touch</h4>
            <div className="flex flex-col gap-8">
              <div className="flex items-start gap-5">
                <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center shrink-0">
                  <MapPin size={18} className="text-[#B31B1B]" />
                </div>
              ...
              <div className="flex items-start gap-5">
                <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center shrink-0">
                  <Phone size={18} className="text-[#B31B1B]" />
                </div>
              ...
              <div className="flex items-start gap-5">
                <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center shrink-0">
                  <Mail size={18} className="text-[#B31B1B]" />
                </div>
                <p className="text-[10px] font-bold uppercase tracking-widest text-white/40">
