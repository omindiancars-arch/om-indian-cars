...
export default function EMICalculator({ price }: { price: string }) {
  ...
  return (
    <div className="bg-[#A10B1C]/5 border border-[#A10B1C]/10 rounded-[2.5rem] p-8 md:p-12">
      <div className="mb-10">
        <h3 className="text-2xl font-heading font-bold uppercase tracking-tighter text-[#A10B1C] mb-2">Finance Estimate</h3>
        <p className="text-[10px] uppercase tracking-widest text-[#A10B1C]/40 font-bold">Customize your luxury payment plan</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            <div className="flex justify-between items-center text-[10px] uppercase tracking-widest font-black text-[#A10B1C]">
            ...
            <input 
              ...
              className="w-full h-1.5 bg-[#A10B1C]/10 rounded-lg appearance-none cursor-pointer accent-[#A10B1C]"
            />
          </div>
        ...
        {/* Result Card */}
        <div className="bg-[#A10B1C] rounded-[2rem] p-10 flex flex-col items-center justify-center text-center shadow-2xl relative overflow-hidden">
