      ...
      <Link href={`/car/${car.id}`} className="block h-full group relative">
        ...
        >
          ...
          <div className="relative aspect-[4/3] overflow-hidden bg-[#1a1a1a]">
            ...
            <div className="absolute bottom-2 right-2 w-10 h-10 z-20 pointer-events-none drop-shadow-[0_0_10px_rgba(255,255,255,1)] group-hover:scale-110 transition-transform duration-500">
