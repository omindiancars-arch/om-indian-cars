  ...
  return (
    <main className="min-h-screen bg-white flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
        <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-[#C4141A]/20 blur-[120px] rounded-full" />
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button 
              disabled={isLoading}
              type="submit"
              className="w-full bg-[#C4141A] text-white py-6 rounded-xl font-heading font-black uppercase tracking-widest text-xs hover:bg-black transition-all flex items-center justify-center gap-3 group relative overflow-hidden disabled:opacity-50 shadow-xl"
            >
              {isLoading ? (
