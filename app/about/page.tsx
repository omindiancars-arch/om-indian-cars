  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative pt-[24rem] md:pt-[22rem] pb-24 px-6 md:px-12 max-w-[1800px] mx-auto overflow-hidden">
        <div className="absolute top-0 right-0 w-[50%] h-full bg-[#B31B1B]/5 -z-10 blur-[120px] rounded-full" />
        
        <div className="flex flex-col md:flex-row gap-20 items-center">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-8">
              <div className="w-12 h-[2px] bg-[#B31B1B]" />
              <span className="text-[10px] font-black uppercase tracking-[0.6em] text-[#B31B1B]">Our Legacy</span>
            </div>
            <h1 className="text-6xl md:text-8xl font-heading font-black uppercase tracking-tighter text-black leading-[0.85] mb-10">
              Cars with <br />
              <span className="text-[#B31B1B]">Trust</span>
            </h1>
          ...
          <div className="flex-1 relative">
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-10 -left-10 bg-[#B31B1B] text-white p-10 rounded-[3rem] shadow-2xl hidden md:block">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="p-12 bg-white rounded-[3.5rem] shadow-xl hover:shadow-2xl transition-all group">
                <div className="w-16 h-16 rounded-2xl bg-[#B31B1B]/5 flex items-center justify-center text-[#B31B1B] mb-8 group-hover:bg-[#B31B1B] group-hover:text-white transition-all">
                  <value.icon size={32} />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-20 items-center">
              ...
              <div className="space-y-12">
                {[
                  ...
                  <div key={i} className="flex gap-8">
                    <span className="text-2xl font-heading font-black text-[#B31B1B]/20">{item.step}</span>
                    <div>
            ...
            <div className="flex-1 order-1 md:order-2">
              <div className="flex items-center gap-3 mb-8">
                <div className="w-12 h-[2px] bg-[#B31B1B]" />
                <span className="text-[10px] font-black uppercase tracking-[0.6em] text-[#B31B1B]">How We Work</span>
              </div>
              ...
              <button className="px-12 py-6 bg-black text-white rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-[#B31B1B] transition-all flex items-center gap-4">
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto bg-[#B31B1B] rounded-[4rem] p-12 md:p-24 text-center text-white relative overflow-hidden shadow-2xl">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6 relative z-10">
            <button className="px-12 py-6 bg-white text-[#B31B1B] rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-black hover:text-white transition-all shadow-xl">
              View Inventory
            </button>
