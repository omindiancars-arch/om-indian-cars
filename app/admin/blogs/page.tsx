                ...
                <td className="px-8 py-10 text-right">
                  <div className="flex justify-end gap-4">
                    <button 
                      ...
                      className="p-4 bg-white/5 hover:bg-white text-white hover:text-[#B31B1B] rounded-xl transition-all shadow-lg"
                    >
        ...
        {isAdding && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-5xl bg-white border border-[#B31B1B]/10 p-12 rounded-[3rem] shadow-2xl flex flex-col max-h-[90vh] overflow-hidden"
            >
              ...
              <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto pr-8 custom-scrollbar space-y-16">
                ...
                <section>
                  <h3 className="text-[10px] uppercase tracking-[0.5em] font-black text-[#B31B1B] mb-10 flex items-center gap-6">
                    <span className="w-8 h-8 rounded-full bg-[#B31B1B]/10 flex items-center justify-center text-[#B31B1B]">01</span> Cover Media
                    <div className="h-[1px] flex-1 bg-[#B31B1B]/10" />
                  </h3>
                  <div className="relative aspect-video max-w-2xl mx-auto bg-[#B31B1B]/5 border-2 border-dashed border-[#B31B1B]/10 rounded-3xl flex flex-col items-center justify-center group hover:bg-[#B31B1B]/10 transition-all cursor-pointer overflow-hidden">
                    {formData.image ? (
                      <>
                      ...
                      <>
                        ...
                        <p className="text-[10px] text-[#B31B1B]/20 font-black uppercase tracking-widest">Upload Cover Image</p>
                      </>
                    )}
                ...
                <section>
                  <h3 className="text-[10px] uppercase tracking-[0.5em] font-black text-[#B31B1B] mb-10 flex items-center gap-6">
                    <span className="w-8 h-8 rounded-full bg-[#B31B1B]/10 flex items-center justify-center text-[#B31B1B]">02</span> Story Content
                    <div className="h-[1px] flex-1 bg-[#B31B1B]/10" />
                  </h3>
                  <div className="space-y-8">
                    <div className="space-y-3">
                      <label className="text-[9px] uppercase tracking-widest text-[#B31B1B] font-black">Title</label>
                      <input 
                        required
                        type="text" 
                        ...
                        className="w-full bg-[#B31B1B]/5 border border-[#B31B1B]/10 p-6 rounded-2xl text-xs uppercase tracking-widest text-[#B31B1B] font-black focus:border-[#B31B1B] outline-none transition-all"
                      />
                    </div>
                    <div className="space-y-3">
                      <label className="text-[9px] uppercase tracking-widest text-[#B31B1B] font-black">Excerpt (Brief Summary)</label>
                      <textarea 
                        value={formData.excerpt}
                        onChange={(e) => setFormData({...formData, excerpt: e.target.value})}
                        rows={2}
                        className="w-full bg-[#B31B1B]/5 border border-[#B31B1B]/10 p-6 rounded-2xl text-xs uppercase tracking-widest text-[#B31B1B] outline-none transition-all"
                      />
                    </div>
                    <div className="space-y-3">
                      <label className="text-[9px] uppercase tracking-widest text-[#B31B1B] font-black">Full Article Body</label>
                      <textarea 
                        required
                ...
                <section>
                  <h3 className="text-[10px] uppercase tracking-[0.5em] font-black text-[#B31B1B] mb-10 flex items-center gap-6">
                    <span className="w-8 h-8 rounded-full bg-[#B31B1B]/10 flex items-center justify-center text-[#B31B1B]">03</span> Publication Meta
                    <div className="h-[1px] flex-1 bg-[#B31B1B]/10" />
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="space-y-3">
                      <label className="text-[9px] uppercase tracking-widest text-[#B31B1B] font-black">Author</label>
                      <input 
                        type="text" 
                        value={formData.author}
                        onChange={(e) => setFormData({...formData, author: e.target.value})}
                        className="w-full bg-[#B31B1B]/5 border border-[#B31B1B]/10 p-4 rounded-xl text-[10px] uppercase tracking-widest text-[#B31B1B] font-black outline-none"
                      />
                    </div>
                    <div className="space-y-3">
                      <label className="text-[9px] uppercase tracking-widest text-[#B31B1B] font-black">Category</label>
                      <input 
                        type="text" 
                    ...
                    <div className="space-y-3">
                      <label className="text-[9px] uppercase tracking-widest text-[#B31B1B] font-black">Date</label>
                      <input 
                        type="date" 
                        value={formData.date}
                    ...
                    <div className="space-y-3">
                      <label className="text-[9px] uppercase tracking-widest text-[#B31B1B] font-black">Read Time</label>
                      <input 
                        type="text" 
                ...
                <div className="flex gap-4 pt-8">
                  <button 
                    type="submit"
                    className="flex-1 bg-[#B31B1B] text-white py-6 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-black transition-all shadow-xl active:scale-95"
                  >
