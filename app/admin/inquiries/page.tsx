          ...
          inquiries.map((inquiry, i) => (
            ...
            >
              ...
              <div className="w-full md:w-auto">
                <button className="w-full md:w-auto bg-white text-[#C4141A] px-8 py-4 text-[10px] uppercase tracking-widest font-black rounded-xl hover:scale-105 transition-all shadow-xl">
                  MARK AS PROCESSED
                </button>
              </div>
            </motion.div>
