          ...
          <div className="lg:col-span-8 space-y-6">
                ...
                >
                  {activeMedia.type === 'video' ? (
                    ...
                    <div className="relative w-full h-full">
                      <img src={activeMedia.url} alt={car.name} className="w-full h-full object-cover scale-[1.05] origin-top-left" />
                      <div className="absolute bottom-4 right-4 md:bottom-8 md:right-8 z-20 pointer-events-none drop-shadow-2xl">
                        <img src="/omindlogo.png" alt="OM Logo" className="w-16 h-16 md:w-20 md:h-20 object-contain" />
                      </div>
                    </div>
                  )}
                </motion.div>
            ...
            <div className="grid grid-cols-5 md:grid-cols-6 gap-4">
              {allMedia.map((media, idx) => (
                ...
                >
                  <div className="relative w-full h-full">
                    <img src={media.url} className="w-full h-full object-cover scale-[1.05] origin-top-left" />
                    <div className="absolute bottom-1 right-1 w-5 h-5 z-10 pointer-events-none drop-shadow-lg">
