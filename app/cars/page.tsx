  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="pt-[24rem] md:pt-[22rem] pb-24 px-6 md:px-12 max-w-[1800px] mx-auto">
        <Link 
          href="/"
          className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.3em] text-[#C50403] hover:text-black transition-all mb-12 group w-fit"
        >
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
              <div className="relative w-full md:w-[400px] group">
                <Search className="absolute left-6 top-1/2 -translate-y-1/2 text-black/20 group-focus-within:text-[#C50403] transition-colors" size={18} />
                <input 
                  type="text" 
                  placeholder="SEARCH ASSETS..."
                  className="w-full bg-gray-50 border border-black/5 py-6 pl-16 pr-8 text-[11px] font-black uppercase tracking-widest outline-none focus:border-[#C50403] focus:bg-white transition-all rounded-2xl text-black"
                  value={searchTerm}
          ...
          <div className="flex-1">
            ...
            {filteredCars.length === 0 && (
              <div className="py-40 text-center">
                ...
                <button onClick={clearFilters} className="px-12 py-6 bg-[#C50403] text-white rounded-2xl font-black uppercase tracking-widest text-[10px]">
                  Reset Collection
                </button>
              </div>
            )}
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-[10px] font-black uppercase tracking-[0.5em] text-[#C50403] animate-pulse">Initializing Collection...</div>
      </div>
    }>
      <InventoryContent />
    </Suspense>
