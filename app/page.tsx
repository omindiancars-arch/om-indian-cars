...
export default function Home() {
  ...
  return (
    <main className="relative flex-1 bg-[#A10B1C] overflow-hidden text-white">
      <Navbar />

      {/* 1. ELITE HERO SECTION (SPLIT SCREEN) */}
      <section className="relative min-h-[85vh] flex flex-col md:flex-row overflow-hidden pt-[20rem] md:pt-[20rem] gap-10 bg-[#A10B1C] px-10">
        {/* Left Half: Photo */}
        <div className="relative md:flex-[0.6] min-h-[40vh] md:min-h-0 group overflow-hidden rounded-[3rem] bg-[#A10B1C]">
        ...
        <div className="absolute bottom-12 left-0 w-full z-40 flex justify-center">
          ...
          >
            <Link href="/cars" className="px-16 py-7 bg-white text-[#A10B1C] rounded-full font-heading font-black uppercase tracking-widest text-xs shadow-2xl hover:bg-black hover:text-white transition-all hover:scale-105 active:scale-95 inline-block">
              Browse Cars
            </Link>
          </motion.div>
        </div>
      ...
      <section className="py-32 bg-[#A10B1C] relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-10">
            ...
            <Link href="/cars" className="px-10 py-5 border-2 border-white/20 rounded-full text-[10px] font-black uppercase tracking-widest text-white hover:bg-white hover:text-[#A10B1C] transition-all flex items-center gap-4">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10">
          {[
            ...
            <div key={i} className="group relative h-[450px] rounded-[4rem] overflow-hidden shadow-2xl border border-white/5">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#A10B1C] via-[#A10B1C]/40 to-transparent p-12 md:p-16 flex flex-col justify-end">
      ...
      <section className="py-32 bg-[#A10B1C]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="p-12 bg-white/5 border border-white/10 rounded-[3.5rem] text-left group hover:bg-white transition-all duration-500">
                <div className="flex gap-1 text-[#FFD700] mb-8 group-hover:text-[#A10B1C]">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-[#FFD700] font-black uppercase tracking-widest mt-1 group-hover:text-[#A10B1C] transition-colors">Owner of {test.car}</p>
                </div>
              </div>
            ))}
          </div>
