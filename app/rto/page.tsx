          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-6">
                {[
                  { title: "RC Transfer", icon: <FileText className="text-[#C4141A]" /> },
                  { title: "NOC Issuance", icon: <CheckCircle className="text-[#C4141A]" /> },
                  { title: "Registration Renewal", icon: <FileCheck className="text-[#C4141A]" /> },
                  { title: "HPA/HPT Deletion", icon: <ShieldCheck className="text-[#C4141A]" /> },
                ].map((item, i) => (
