          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-6">
                {[
                  { title: "RC Transfer", icon: <FileText className="text-[#C50403]" /> },
                  { title: "NOC Issuance", icon: <CheckCircle className="text-[#C50403]" /> },
                  { title: "Registration Renewal", icon: <FileCheck className="text-[#C50403]" /> },
                  { title: "HPA/HPT Deletion", icon: <ShieldCheck className="text-[#C50403]" /> },
                ].map((item, i) => (
