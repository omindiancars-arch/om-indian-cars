  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="pt-[24rem] md:pt-[20rem] pb-32 px-6 md:px-12 max-w-7xl mx-auto">
        <Link 
          href="/"
          className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.3em] text-black/40 hover:text-[#B31B1B] transition-all mb-12 group w-fit"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
          <div className="lg:col-span-5 space-y-16">
            {[
              ...
              <div key={i} className="flex gap-8 group">
                <div className="w-16 h-16 rounded-[2rem] bg-gray-50 border border-black/5 flex items-center justify-center shrink-0 group-hover:bg-[#B31B1B] group-hover:text-white transition-all duration-500">
                  <item.icon size={24} className="text-[#B31B1B] group-hover:text-white transition-colors" />
                </div>
                <div>
                  ...
                  <a 
                    ...
                    className="text-sm font-black uppercase tracking-widest text-black leading-relaxed whitespace-pre-line hover:text-[#B31B1B] transition-colors"
                  >
                    {item.val}
                  </a>
                </div>
          ...
          <div className="lg:col-span-7">
            {submitted ? (
              ...
              >
                <div className="w-24 h-24 bg-[#B31B1B] rounded-full flex items-center justify-center text-white mb-8 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="bg-gray-50 border border-black/5 p-12 md:p-20 rounded-[4rem] space-y-10 shadow-xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="space-y-4">
                    ...
                    <input 
                      ...
                      className="w-full bg-white border border-black/5 p-6 rounded-2xl text-black text-xs font-black uppercase outline-none focus:border-[#B31B1B] transition-all"
                      value={formData.name}
                ...
                <div className="space-y-4">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-white border border-black/5 p-8 rounded-[2.5rem] text-black text-xs font-black uppercase outline-none focus:border-[#B31B1B] transition-all resize-none"
                ...
                <button 
                  type="submit"
                  className="w-full py-8 bg-[#B31B1B] text-white rounded-2xl font-black uppercase tracking-widest text-[11px] hover:bg-black transition-all shadow-xl shadow-red-900/20 active:scale-[0.98]"
                >
