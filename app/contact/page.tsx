          ...
          <div className="lg:col-span-5 space-y-16">
            {[
              ...
              <div key={i} className="flex gap-8 group">
                <div className="w-16 h-16 rounded-[2rem] bg-gray-50 border border-black/5 flex items-center justify-center shrink-0 group-hover:bg-[#CE1126] group-hover:text-white transition-all duration-500">
                  <item.icon size={24} className="text-[#CE1126] group-hover:text-white transition-colors" />
                </div>
                <div>
                  ...
                  <a 
                    ...
                    className="text-sm font-black uppercase tracking-widest text-black leading-relaxed whitespace-pre-line hover:text-[#CE1126] transition-colors"
                  >
                    {item.val}
                  </a>
                </div>
              ...
              <form onSubmit={handleSubmit} className="bg-gray-50 border border-black/5 p-12 md:p-20 rounded-[4rem] space-y-10 shadow-xl">
                ...
                <div className="space-y-4">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-white border border-black/5 p-8 rounded-[2.5rem] text-black text-xs font-black uppercase outline-none focus:border-[#CE1126] transition-all resize-none"
                ...
                <button 
                  type="submit"
                  className="w-full py-8 bg-[#CE1126] text-white rounded-2xl font-black uppercase tracking-widest text-[11px] hover:bg-black transition-all shadow-xl shadow-red-900/20 active:scale-[0.98]"
                >
