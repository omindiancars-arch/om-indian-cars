          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
            ...
            <div className="lg:col-span-7">
              <form onSubmit={handleSubmit} className="bg-gray-50 border border-black/5 p-12 md:p-20 rounded-[4rem] space-y-16 shadow-xl">
                ...
                <button 
                  type="submit"
                  className="w-full py-8 bg-[#B31B1B] text-white rounded-2xl font-black uppercase tracking-[0.4em] text-[11px] hover:bg-black transition-all shadow-xl shadow-red-900/20 flex items-center justify-center gap-4 group"
                >
            ...
            <div className="lg:col-span-5 space-y-12">
              {[
                ...
                <div key={i} className="p-10 bg-white border border-black/5 rounded-[3rem] shadow-sm hover:shadow-xl transition-all duration-500 group">
                  <div className="w-14 h-14 bg-gray-50 rounded-2xl flex items-center justify-center text-[#B31B1B] mb-6 group-hover:bg-[#B31B1B] group-hover:text-white transition-all">
              ...
              <div className="pt-12 p-10 bg-black text-white rounded-[3rem] relative overflow-hidden group">
                <div className="relative z-10">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-[1px] bg-[#B31B1B]" />
                    <span className="text-[9px] font-black uppercase tracking-[0.3em] text-[#B31B1B]">Management Office</span>
                  </div>
                </div>
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#B31B1B]/10 blur-[50px] -mr-16 -mt-16 group-hover:bg-[#B31B1B]/20 transition-all" />
              </div>
            </div>
          </div>
        )}
