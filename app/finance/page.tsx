        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-neutral-50 rounded-[3rem] p-12 md:p-20 shadow-xl border border-neutral-100">
            <div className="flex items-center gap-6 mb-12">
              <div className="w-16 h-16 rounded-2xl bg-[#C4141A] flex items-center justify-center text-white shadow-lg">
                <Banknote size={32} />
              </div>
              <div>
                <h2 className="text-3xl font-black uppercase tracking-tight text-neutral-900">Finance Options</h2>
                <div className="h-1 w-12 bg-[#C4141A] mt-2" />
              </div>
            </div>

            <div className="space-y-12">
              <div className="bg-white p-10 rounded-[2rem] border border-[#C4141A]/10 shadow-sm">
                <p className="text-2xl md:text-4xl font-black text-[#C4141A] leading-tight uppercase tracking-tight">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  { title: "Instant Approval", desc: "Get your loan processed within hours with minimal documentation.", icon: <CheckCircle2 className="text-[#C4141A]" /> },
                  { title: "Flexible Tenure", desc: "Choose a repayment plan that fits your budget, up to 7 years.", icon: <TrendingUp className="text-[#C4141A]" /> },
                  { title: "Low Interest Rates", desc: "Benefit from our tie-ups with leading banks for competitive rates.", icon: <Banknote className="text-[#C4141A]" /> },
                  { title: "Complete Transparency", desc: "No hidden charges or processing fee surprises.", icon: <ShieldCheck className="text-[#C4141A]" /> },
                ].map((item, i) => (
